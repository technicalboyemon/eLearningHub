        ...
        <div className="row py-5 align-items-center">
          <div className="col-md-6">
            <div className="about-img">
              <img className="rounded-3 w-100" src={contactUs} alt="Contact" />
            </div>
          </div>
          <div className="col-md-6">
            <div className="aboutInfo">
              ...
              <p>
                Mauris eu fringilla lorem. Phasellus a sem nisl. Sed tempor arcu
                ac condimentum molestie. Morbi ullamcorper eleifend scelerisque.
                Aliquam venenatis eros elementum felis tincidunt scelerisque.
              </p>
              ...
              <svg width="40" height="40" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M20.5837 11.3261C20.5837 17.1859 13.0003 22.2087 13.0003 22.2087C13.0003 22.2087 5.41699 17.1859 5.41699 11.3261C5.41699 9.32792 6.21595 7.41159 7.6381 5.99868C9.06025 4.58576 10.9891 3.79199 13.0003 3.79199C15.0116 3.79199 16.9404 4.58576 18.3626 5.99868C19.7847 7.41159 20.5837 9.32792 20.5837 11.3261Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M13.0004 13.8372C14.3965 13.8372 15.5282 12.7128 15.5282 11.3258C15.5282 9.93883 14.3965 8.81445 13.0004 8.81445C11.6044 8.81445 10.4727 9.93883 10.4727 11.3258C10.4727 12.7128 11.6044 13.8372 13.0004 13.8372Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                  </div>
                  <span className="text-secondary fs-5">Dhaka, Bangladesh</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row py-4">
            <div className="col-md-5">
              <div className="contactInfo  pb-3">
                <div className="contactInfoBox bg-white rounded p-4 d-flex justify-content-center align-items-center">
                  ...
                  <div className="contactInfo w-75">
                    <span className="d-block fs-6 text-secondary fw-bold">ADDRESS</span>
                    <span className="d-block fs-5">Dhaka, Bangladesh</span>
                  </div>
                </div>
              </div>
              <div className="contactInfo py-3">
                <div className="contactInfoBox bg-white rounded p-4 d-flex justify-content-center align-items-center">
                  ...
                  <div className="contactInfo w-75">
                    <span className="d-block fs-6 text-secondary fw-bold">EMAIL</span>
                    <span className="d-block fs-5">
                      technicalboyemon@gmail.com
                    </span>
                  </div>
                </div>
              </div>
              <div className="contactInfo py-3">
                <div className="contactInfoBox bg-white rounded p-4 d-flex justify-content-center align-items-center">
                  ...
                  <div className="contactInfo w-75">
                    <span className="d-block fs-6 text-secondary fw-bold">PHONE</span>
                    <span className="d-block fs-5">+880 1921412932</span>
                  </div>
                </div>
              </div>
            </div>
            <div className="col-md-7">
              <div className="contactForm rounded py-3 bg-white p-4">
                ...
                <div>
                  <div className="mb-3">
                    <label for="subject" className="form-label fw-bold">
                      Subject
                    </label>
                    <input
                      type="text"
                ...
                <div className="mb-3">
                  <label for="Messages" className="form-label fw-bold">
                    Messages
                  </label>
                  <textarea
                    className="form-control"
